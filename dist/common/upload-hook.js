...
exports.default = (function () {
    return function (context) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            app = context.app, method = context.method, type = context.type;
            if (method === 'create' && type === 'after') {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var fileTypes = mime_types_1.lookup(file.originalname);
                        if (!fileTypes) {
                        ...
                        var bucket = storage.bucket(app.get('bucketName'));
                        var blob = bucket.file(uuid_1.v4() + "." + mime_types_1.extensions[fileTypes][0]);
